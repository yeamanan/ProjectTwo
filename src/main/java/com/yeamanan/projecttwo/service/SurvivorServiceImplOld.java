...
/**
 * SurvivorServiceImplOld class.
 *
 * @author Yeam Anan (<yeamanan|at|gmail|dot|com>)
 */
public class SurvivorServiceImplOld implements SurvivorService {

    /**
     * Logger.
     */
    private static final Logger LOGGER =
            Logger.getLogger(SurvivorServiceImplOld.class);
    ...
    public final List<Survivor> loadAll() {
        final List<Survivor> survivors = new ArrayList<>();
        for (String sName : getFileNames()) {
            survivors.add(load(sName));
        }
        return survivors;
    }
